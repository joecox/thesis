...
Oracle and OpenJDK. \phosphor{} works by instrumenting the JVM and the
entire application bytecode with operations to accurately propagate
taint information. Prior work aimed at reducing the performance
overhead of \phosphor{} by doing partial instrumentation. The analysis
that determined which parts of the program to instrument was effective
but flawed.
